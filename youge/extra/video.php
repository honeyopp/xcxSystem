...
return  [
    ...
    'toutiao' => [
        ...
        'menu' => [
            'nav' => [
                'name' => '分类管理',
                'link' => '/miniapp/video.type/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
                    [ 'name' => '新增分类', 'link' => 'video.type/create', 'is_show' => 0,],
                    [ 'name' => '分类列表管理', 'link' => 'video.type/index', 'is_show' => 0,],
                    [ 'name' => '编辑分类', 'link' => 'video.type/edit', 'is_show' => 0,],
                    [ 'name' => '删除分类', 'link' => 'video.type/delete', 'is_show' => 0,],
                ],
            ],
            'toutiao' => [
                'name' => '视频头条',
                'link' => '/miniapp/video.video/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
            ...
            '评论管理' => [
                'name' => '头条评论',
                'link' => '/miniapp/video.comment/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
