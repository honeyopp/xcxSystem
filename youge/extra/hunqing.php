...
return  [
    ...
    'company' => [
        ...
        'menu' => [
            ...
            'company' => [
                'name' => '商家列表',
                'link' => '/miniapp/hunqing.company/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
                    [ 'name' => '新增商家', 'link' => 'hunqing.company/create', 'is_show' => 0,],
                    [ 'name' => '商家管理', 'link' => 'hunqing.company/index', 'is_show' => 0,],
                    [ 'name' => '商家编辑', 'link' => 'hunqing.company/edit', 'is_show' => 0,],
                    [ 'name' => '商家删除', 'link' => 'hunqing.company/delete', 'is_show' => 0,],
                ],
            ],
            'yuyue' => [
                'name' => '预约商家',
            ...
            'tender' => [
                'name' => '会员招标',
                'link' => '/miniapp/hunqing.tender/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
                    [ 'name' => '预约管理', 'link' => 'company.yuyue/index', 'is_show' => 0,],
