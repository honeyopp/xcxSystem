...
$protected = [
    ...
    'product' => [
        ...
        'menu' => [
            'category' => [
                'name' => '商品分类',
                'link' => '/miniapp/shop2.category/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
                    [ 'name' => '添加分类', 'link' => 'shop2.category/create', 'is_show' => 0,],
                    [ 'name' => '分类列表', 'link' => 'shop2.category/index', 'is_show' => 0,],
                    [ 'name' => '编辑分类', 'link' => 'shop2.category/edit', 'is_show' => 0,],
                    [ 'name' => '删除分类', 'link' => 'shop2.category/delete', 'is_show' => 0,],
                ],
            ],
            'product' => [
                'name' => '商品管理',
                'link' => '/miniapp/shop2.goods/index',
                'is_show' => 1, //是否显示菜单
                'is_sub' => 0, //是否显示下级菜单
                'sub' => [
                    [ 'name' => '添加商品', 'link' => 'shop2.goods/create', 'is_show' => 0,],
                    [ 'name' => '商品列表', 'link' => 'shop2.goods/index', 'is_show' => 0,],
                    [ 'name' => '编辑商品', 'link' => 'shop2.goods/edit', 'is_show' => 0,],
                    [ 'name' => '删除商品', 'link' => 'shop2.goods/delete', 'is_show' => 0,],
                ],
            ],
        ],
    ],
