...
class  HotelpriceModel extends CommonModel{
    protected $pk       = 'price_id';
    protected $table    = 'hotel_room_price';
    ...
    */
    public function backPrice($hotel_id,$miniapp_id,$date,$online = false){
        $room_where['hotel_id'] = $where['hotel_id'] = (int) $hotel_id;
